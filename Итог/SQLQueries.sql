...
--вывести студенческие абонементы в руб. и $
select [Код абонемента],Стоимость as [Стоимость руб], Стоимость/73.19 as [Стоимость $] 
from [Тип Абонемента]
...
--вывести всю информацию о клиентах и тренировках
select distinct *
from Тренировки cross join Клиенты
where Тренировки.[Код клиента]=Клиенты.[Код клиента]
--=====================================================================================================================================================================
...
add [Код тренировки] int identity (1,1)
go
alter table Тренировки
drop constraint PK_Тренировки
go
alter table Тренировки
add constraint PK_Тренировки
Primary key ([Код тренировки])